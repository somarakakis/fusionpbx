...
$text['language-name']['el-gr'] = "Ελληνικά - Greece";
...
$text['language-de-de']['el-gr'] = "Ελληνικά - Greece";
...
$text['message-update']['el-gr'] = "Ενημερώθηκε";
...
$text['message-required']['el-gr'] = "Προσδιορίστε τα ακόλουθα:";
...
$text['message-delete']['el-gr'] = "Διαγράφηκε";
...
$text['message-add']['el-gr'] = "Προστέθηκε με επιτυχία";
...
$text['message-failed']['el-gr'] = "Η ενημέρωση απέτυχε - Επικοινωνήστε με την υποστήριξη";
...
$text['message-copy']['el-gr'] = "Αντιγραφή Ολοκληρώθηκε";
...
$text['message-invalid_credentials']['el-gr'] = "Μη έγκυρο/ς όνομα χρήστη και/ή κωδικός πρόσβασης";
...
$text['message-restore']['el-gr'] = "Επαναφορά Ολοκληρώθηκε";
...
$text['message-duplicate']['el-gr'] = "Υπάρχει ήδη";
...
$text['confirm-delete']['el-gr'] = "Είστε σίγουροι ότι θέλετε να το διαγράψετε?";
...
$text['button-apply']['el-gr'] = "Εφαρμογή";
...
$text['button-provision']['el-gr'] = "Τροφοδότηση";
...
$text['button-applied']['el-gr'] = "Εφαρμόσθηκε";
...
$text['button-login']['el-gr'] = "Είσοδο";
...
$text['button-reload']['el-gr'] = "Ανανέωση";
...
$text['button-view']['el-gr'] = "Προβολή";
...
$text['button-download']['el-gr'] = "Λήψη";
...
$text['button-downloads']['el-gr'] = "Λήψεις";
...
$text['button-advanced']['el-gr'] = "Προηγμένα";
...
$text['button-basic']['el-gr'] = "Βασικά";
...
$text['button-summary']['el-gr'] = "Περίληψη";
...
$text['button-qr_code']['el-gr'] = "QR Κωδικός";
...
$text['description-import']['el-gr'] = "Μεταφόρτωση οριοθετημένων δεδομένων για προσθήκη πολλαπλών εγγραφών.";
...
$text['label-import_delimiter']['el-gr'] = "Διαχωριστής";
$text['label-import_delimiter']['el-gr'] = "Trennzeichen";
...
$text['label-import_enclosure']['el-gr'] = "Οριοθέτησης";
...
$text['label-from_row']['el-gr'] = "Από Σειρά";
...
$text['description-from_row']['el-gr'] = "Αρχίστε να εισάγετε τα δεδομένα από αυτήν τη σειρά.";
...
$text['description-import_data']['el-gr'] = "Αντιγράψτε και επικολλήστε τα οριοθετημένα δεδομένα με κόμμα στην περιοχή κειμένου για να ξεκινήσετε την εισαγωγή";
...
$text['description-import_delimiter']['el-gr'] = "Επιλέξτε τον Διαχωριστή (κόμμα ή παύλα)";
...
$text['description-import_enclosure']['el-gr'] = "Επιλέξτε τοn Οριοθέτη του κειμένου (διπλά εισαγωγικά ή τίποτα).";
...
$text['option-this_month']['el-gr'] = "Αυτόν το μήνα";
...
$text['option-this_year']['el-gr'] = "Αυτό το έτος";
...
$text['label-start_date_time']['el-gr'] = "Ημερομηνία/Ώρα Εκκίνησης";
...
$text['label-start']['el-gr'] = "Εκκίνηση";
...
$text['label-end_range']['el-gr'] = "Περιοχή Τέλους";
...
$text['label-disabled']['el-gr'] = "Ανενεργό";
...
$text['label-domain_uuid']['el-gr'] = "Domain";
...
$text['label-global']['el-gr'] = "Global";
...
$text['label-ringtones']['el-gr'] = "Ήχοι κλήσης";
...
$text['label-git_branch']['el-gr'] = "Branch:";
...
$text['label-git_commit']['el-gr'] = "Commit:";
...
$text['label-recording']['el-gr'] = "Ηχογράφηση";
...
$text['label-download']['el-gr'] = "Λήψη";
...
$text['label-bridges']['el-gr'] = 'Γέφυρες';
...
$text['description-greeting']['el-gr'] = "Επιλέξτε το επιθυμητό ID χαιρετισμού.";
...
$text['description-name']['el-gr'] = "Εισάγετε το όνομα.";
...
$text['description-type']['el-gr'] = "Πληκτρολογήστε τον τύπο ρύθμισης (π.χ. uuid, όνομα, var, dir, κλπ).";
...
$text['description-description']['el-gr'] = "Πληκτρολογήστε την περιγραφή.";
...
$text['description-enter-context']['el-gr'] = "Εισαγάγετε το context.";
